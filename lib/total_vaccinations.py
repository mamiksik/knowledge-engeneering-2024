...
columns_needed = ['date', 'location', 'new_cases']
...
filtered_df['amount'] = filtered_df['amount'].astype(int)
...
# to RDF
# Load the CSV file
df = pd.read_csv('/Users/surenskardova/PycharmProjects/knowledge-engeneering-2024/lib/filtered_vaccination_data.csv')
